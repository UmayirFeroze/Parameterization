...
Route::put('parameters/{id}/updateDropdown', [ParameterController::class, 'updateDropdown'])->name('parameteres.dropdown.update');
Route::get('parameters/{id}/edit', [ParameterController::class, 'editValue'] )->name('parameters.editValue');
